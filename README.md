# ai-uc-rpa-guidance-fe

[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_ai-uc-rpa-guidance-fe&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=DEFRA_ai-uc-rpa-guidance-fe)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_ai-uc-rpa-guidance-fe&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=DEFRA_ai-uc-rpa-guidance-fe)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_ai-uc-rpa-guidance-fe&metric=coverage)](https://sonarcloud.io/summary/new_code?id=DEFRA_ai-uc-rpa-guidance-fe)
...
> compatibility fEx: `docker build --platform=linux/arm64 --no-cache --tag ai-uc-rpa-guidance-fe`

Build:

```bash
docker build --target development --no-cache --tag ai-uc-rpa-guidance-fe:development .
```

Run:

```bash
docker run -p 3000:3000 ai-uc-rpa-guidance-fe:development
```
...
```bash
docker build --no-cache --tag ai-uc-rpa-guidance-fe .
```

Run:

```bash
docker run -p 3000:3000 ai-uc-rpa-guidance-fe
```
